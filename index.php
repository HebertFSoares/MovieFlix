...
?>
  <div id="main-container" class="container-fluid">
    <?php if( $userData == false): ?>
      ...
      <div class="image-home"><img src="<?= $BASE_URL ?>img/img-home.png" alt="MovieFlix"></div>
    <?php else: ?>
      ...
      <?php else: ?>
        ...
        <p class="section-description">Veja as críticas dos últimos filmes adicionados no MovieFlix</p>
